...
# This file lives at .../Mujoco/rlds_dataset_builder/raccoon_pick_place/<this file>,
# so parents[2] is the "Mujoco" directory that also contains "raccoon_dataset".
# Override with the RACCOON_INTERMEDIATE_ROOT env var if the data lives elsewhere.
_DEFAULT_INTERMEDIATE_ROOT = (
    Path(__file__).resolve().parents[2]
    / "raccoon_dataset"
    / "openvla_rlds_intermediate"
)
INTERMEDIATE_ROOT = Path(
    os.environ.get("RACCOON_INTERMEDIATE_ROOT", _DEFAULT_INTERMEDIATE_ROOT)
)
